...
public class PartnerAdminCommand implements CommandExecutor, TabCompleter {
    ...
    private void handleReset(CommandSender sender, String[] args) {
        ...
        SchedulerUtil.runTaskAsynchronously(plugin, () -> {
            ...
            Partnership partnership = plugin.getDatabaseManager().getPartnership(targetUUID);
            if (partnership == null) {
    ...
    private void handleSet(CommandSender sender, String[] args) {
        ...
        SchedulerUtil.runTaskAsynchronously(plugin, () -> {
            ...
            Partnership p1 = plugin.getDatabaseManager().getPartnership(uuid1);
            if (p1 != null) {
            ...
            Partnership p2 = plugin.getDatabaseManager().getPartnership(uuid2);
            if (p2 != null) {
            ...
            SchedulerUtil.runTask(plugin, () -> sender.sendMessage(plugin.getLanguageManager().getMessage("admin-set-success", true)
                .replace("{p1}", name1)
                .replace("{p2}", name2)));
        });
    }
